...
$location = "/home/mnt/data/home";
$base = 1024;
$si_prefix = array( 'b', 'k', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB' );
$torrents = shell_exec("ls /home/mnt/data/home/".$username."/.sessions/*.torrent|wc -l");
$dtorrents = shell_exec("ls /home/mnt/data/home/".$username."/.config/deluge/state/*.torrent|wc -l");
...
if (file_exists('/install/.quota.lock')) {
  $dftotal = shell_exec("sudo /usr/sbin/repquota /home/mnt/data/home|/bin/grep ^".$username."|/usr/bin/awk '{printf \$4/1024/1024}'");
  $dffree = shell_exec("sudo /usr/sbin/repquota /home/mnt/data/home|/bin/grep ^".$username."|/usr/bin/awk '{printf (\$4-\$3)/1024/1024}'");
  $dfused = shell_exec("sudo /usr/sbin/repquota /home/mnt/data/home|/bin/grep ^".$username."|/usr/bin/awk '{printf \$3/1024/1024}'");
  $perused = sprintf('%1.0f', $dfused / $dftotal * 100);

} else {

  $bytesfree = disk_free_space('/home/mnt/data/home');
  ...
  try {
    $diskStatus = new DiskStatus('/home/mnt/data/home');
...
if (file_exists('/home/mnt/data/home/'.$username.'/.sessions/rtorrent.lock')) {
      $rtorrents = shell_exec("ls /home/mnt/data/home/".$username."/.sessions/*.torrent|wc -l");
}
...
?>
                  ...
                  <hr />
                  <?php if (processExists("rtorrent",$username) && file_exists('/home/mnt/data/home/'.$username.'/.sessions/rtorrent.lock')) { ?>
